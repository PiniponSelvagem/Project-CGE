...
LightPoint::LightPoint(glm::vec3 position, glm::vec3 color,
			...
			float falloffNear, float falloffFar
...
float LightPoint::getAttenuation() { return attenuation; }
float LightPoint::getFalloffNear() { return falloffNear; }
float LightPoint::getFalloffFar()  { return falloffFar;  }